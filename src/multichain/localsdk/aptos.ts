...
export class APTOS extends AptosCore implements IDefaultChainLocal {
     ...
     */
    async sendTransaction(signed_tx: Uint8Array): Promise<XmTransactionResponse> {
        try {
     ...
     */
    async submitRawTransaction(rawTransaction: Uint8Array): Promise<XmTransactionResponse> {
        try {
