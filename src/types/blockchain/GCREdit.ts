...
import { PqcIdentityRemovePayload, UDIdentityPayload, XMCoreTargetIdentityPayload, NomisWalletIdentity, EthosWalletIdentity } from "../abstraction"
...
export interface GCREditIdentity {
    ...
    isRollback: boolean
    account: string
    context: "xm" | "web2" | "pqc" | "nomis" | "ud" | "ethos"
    operation: "add" | "remove"
    data:
