...
export function uint8ArrayToHex(bytes: Uint8Array): string {
  ...
  export function hexToUint8Array(hexString: string): Uint8Array {
    ...
    const normalizedHexString = hexString.startsWith('0x') ? hexString.slice(2) : hexString;
...
export function isForgePublicKey(
    key: Uint8Array | forge.pki.ed25519.NativeBuffer,
): key is forge.pki.ed25519.NativeBuffer {
    return typeof key === "object" && "n" in key && "e" in key
}
/**
